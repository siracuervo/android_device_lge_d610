...
# RIL
BOARD_RIL_CLASS := ../../../device/lge/d610/ril/
...
# Graphics
BOARD_EGL_CFG := device/lge/d610/prebuilt/egl.cfg
...
BOARD_HARDWARE_CLASS := device/lge/d610/cmhw/

# Bluetooth
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/lge/d610/bluetooth
...
TARGET_RECOVERY_FSTAB := device/lge/d610/rootdir/recovery.fstab
...
PRODUCT_COPY_FILES += device/lge/d610/rootdir/twrp.fstab:recovery/root/etc/twrp.fstab
PRODUCT_COPY_FILES += device/lge/d610/rootdir/extra.fstab:recovery/root/etc/extra.fstab
